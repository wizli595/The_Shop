...
const NotFoundScreen = () => {
    return (<>
        <section className="d-flex items-center h-full sm:p-16 dark:bg-gray-900 dark:text-gray-100" style={{ alignItems: "center", height: "80vh" }}>
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8 space-y-8 text-center 
            sm:max-w-md " style={{ width: "auto" }}>
                ...
                <Link to={"/"} className="px-8 py-3 font-semibold rounded dark:bg-violet-400 dark:text-gray-900">go back</Link>
            </div>
        </section>
